...
public class FileUtils  {
    ...
    public static final String ROOT_DIR = "Lotus/data";
     ...
     * @param mode
     */
    public static void changMode(String path, String mode) {
        try {
     ...
     * @throws Exception
     */
    public static File saveImage2File(Bitmap bitmap, String name)
            throws Exception {
        String path = getExternalStoragePath() + "photo";
        // 创建文件目录
