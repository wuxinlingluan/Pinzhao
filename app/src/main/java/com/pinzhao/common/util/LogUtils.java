...
public class LogUtils {
	...
	/** 日志输出时的TAG */
	private static String mTag = "Lotus";
	/** 是否允许输出log */
	private static int mDebuggable = LEVEL_ERROR;
	/**
	 * 日志是否使能(开发时打开,正式发布时建议关闭)
	 */
	private static boolean mDebugEnableFlag = PinzhaoConstants.DEBUG_MODE_ENABLE;
	...
	/**
	 * 以级别为 v 的形式输出LOG以级别为 d 的形式输出LOG
	 * 
	 * @param msg
	 */
