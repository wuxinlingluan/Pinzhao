...
public class StringUtils {
     ...
     *
     * @param value
     * @return 如果为null或者是空字符串或者只有空格或者为"null"字符串，则返回true，否则则返回false
     */
     ...
     * @return
     */
    public static String convertListToString(ArrayList<String> selectDatas,
                                             String split) {
        StringBuilder sb = new StringBuilder();
        if (selectDatas.isEmpty()) {
            ...
            for (int i = 0; i < selectDatas.size(); i++) {
                if (i == selectDatas.size() - 1) {
                    sb.append(selectDatas.get(i));
                } else {
                    sb.append(selectDatas.get(i) + split);
                }
            }
            return sb.toString();
        }
